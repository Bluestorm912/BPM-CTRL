...
export const soundCloudTransmissions: SoundCloudTransmission[] = [
  {
    ...
    coverImage: heroBg,
    category: "Techno",
    description: "A driving reference stream for the BPM CTRL discovery layer.",
    date: "2024-10-13",
    featured: true,
  },
  {
    ...
    coverImage: mascotDj,
    category: "House",
    description: "A room-ready transmission for club pressure and late-night motion.",
    date: "2026-03-31",
    featured: true,
  },
  {
    ...
    category: "Archive",
    description: "A flexible archive slot for future BPM CTRL sets, shows, and playlists.",
    date: "2026-05-05",
    featured: false,
  },
];
