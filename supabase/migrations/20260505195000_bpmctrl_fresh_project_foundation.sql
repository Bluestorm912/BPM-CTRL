...
('event', 'event_tagline', 'Incoming Drop', 'text', 1),
('event', 'event_description', 'An intimate frequency for sound, movement, and people who know the room matters as much as the music.', 'text', 2),
('event', 'event_date', 'TBA 2026', 'text', 3),
('event', 'event_location', 'Classified', 'text', 4),
('event', 'event_capacity', 'Limited', 'text', 5),
('event', 'event_lineup', 'TBA', 'text', 6),
('event', 'event_cta_primary', 'Request Access', 'text', 7),
...
('community', 'community_title_1', 'Designed for the room.', 'text', 0),
('community', 'community_title_2', 'Built for the culture.', 'text', 1),
('community', 'community_body_1', 'BPM CTRL is a Nigerian-born signal for Afro house, underground movement, and fashion-led nightlife.', 'text', 2),
('community', 'community_body_2', 'The app keeps the circle close: radio, playlists, drops, support, and archive in one black-glass space.', 'text', 3),
('community', 'community_body_3', 'No noise. No clutter. Just signal.', 'text', 4),
